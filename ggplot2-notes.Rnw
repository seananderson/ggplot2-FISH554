% Sean Anderson, 2012-14, sean@seananderson.ca
...
theme_example <- function (base_size = 12, base_family = "") {
  theme_gray(base_size = base_size, base_family = base_family) %+replace%
    theme(axis.text = element_text(colour = "grey50"),
          ...
          panel.grid.minor.y = theme_blank(),
          panel.grid.minor.x = theme_blank(),
...
\item[\pkg{ggvis}]\hfill \\
  ...
  grammar of graphics for web-based output. Take a look at the vignettes ---
